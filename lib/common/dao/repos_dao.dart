...
import 'package:gsy_app/db/provider/repos/repository_commits_db_provider.dart';
import 'package:gsy_app/db/provider/repos/repository_detail_db_provider.dart';
import 'package:gsy_app/db/provider/repos/repository_detail_readme_db_provider.dart';
import 'package:gsy_app/db/provider/repos/repository_event_db_provider.dart';
import 'package:gsy_app/db/provider/repos/repository_fork_db_provider.dart';
import 'package:gsy_app/db/provider/repos/repository_star_db_provider.dart';
import 'package:gsy_app/db/provider/repos/repository_watcher_db_provider.dart';
import 'package:gsy_app/db/provider/repos/trend_repository_db_provider.dart';
import 'package:gsy_app/db/provider/user/user_repos_db_provider.dart';
import 'package:gsy_app/db/provider/user/user_stared_db_provider.dart';
...
import 'package:gsy_app/model/FileModel.dart';
import 'package:gsy_app/model/PushCommit.dart';
import 'package:gsy_app/model/Release.dart';
import 'package:gsy_app/model/RepoCommit.dart';
import 'package:gsy_app/model/Repository.dart';
import 'package:gsy_app/model/RepositoryQL.dart';
import 'package:gsy_app/model/TrendingRepoModel.dart';
...
import 'package:gsy_app/common/net/trending/github_trending.dart';
        ...
        if (result > 0) {
          ...
          if (showTip)
            Fluttertoast.showToast(
                msg: localization.app_not_new_version);
        }
      }
    }
  }
